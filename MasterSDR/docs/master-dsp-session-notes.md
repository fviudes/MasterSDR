# MasterDsp Settings + NR4 — Session Notes

Development notes from the `feature/mastersdr-dsp-settings` branch.
...
- **MasterDsp Settings dialog** — new settings dialog for fine-tuning NR2
...
- The MasterDspDialog wiring is duplicated in 3 places (Settings menu, NR2
...
| `src/gui/MasterDspDialog.h/.cpp` | New — settings dialog with NR2 + NR4 tabs |
